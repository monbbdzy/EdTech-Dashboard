...
st.caption("Monitor students' performance across the English and Math course")
st.divider()

#__Grades bar___
st.header("Students of English and Math Module")
st.caption("... and their performance across the units.")
is_english_and_math = ((student_data["Course"].str.contains("English", case=False)) & 
                        (student_data["Course"].str.contains("Math", case=False)))
e_m_grades_df = student_data[is_english_and_math]
st.dataframe(e_m_grades_df, column_config={
    "Course":None, 
